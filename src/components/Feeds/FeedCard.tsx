  ...
  return (
    <div className="bg-[#f7ebff] rounded-[26px] p-2 w-full max-w-[700px] mx-auto shadow-md">
      ...
      <div className="flex mt-3 items-center justify-between text-gray-600 text-sm">
        ...
        <button onClick={() => setShowModal(true)} className="flex items-center h-[40px] w-[120px] rounded-full bg-[#E6DAED] text-black font-semibold px-3 hover:bg-[#d8c3e2] transition duration-300">
          <img
            src={Share}
            alt="Share Icon"
            className="w-[20px] h-[20px] object-cover mr-2"
