    ...
    return (
        <div className="h-screen relative">
            ...
            <div className="relative flex flex-col items-center mb-3">
                <img src={Back} alt="back" className="absolute left-3 top-2 w-[32px] h-[32px]" />
                <button onClick={() => navigate("/home/edit-profile")} className=" w-[208px] h-[32px] absolute top-44 left-28 mt-15 px-4 py-1 border border-gray-400 rounded-2xl text-[12PX] font-[700]">
                    Edit Profile
                </button>
                <img
                    src={Cover}
